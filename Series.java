...
/*Реал-мые методы И. должны бытьд.б. объявлены открытыми (puЫic).
Пример класса ByTwos, реал-щего И. Series. В классе формируется
последовательный ряд числ. зн-й, каждое из кот. на 2 больше предыдущего.
*/
