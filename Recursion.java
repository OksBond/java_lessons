...
class Factorial {
    ...
    int factR(int n) {
        ...
        if (n == 1) return 1;
        result = factR(n - 1) * n;    //Excute the recursive call to factR
        return result;
    }
...
public class Recursion {
    public static void main(String[] args) {
        ...
        System.out.println("Factorials using recursive methos.");
        System.out.println("Factorial of 3 is " + f.factR(3));
        System.out.println("Factorial of 4 is " + f.factR(4));
        System.out.println("Factorial of 5 is " + f.factR(5));
        System.out.println();

        System.out.println("Factorials using iterative methos.");
